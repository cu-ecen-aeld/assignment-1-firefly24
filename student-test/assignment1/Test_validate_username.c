...
void test_validate_my_username()
{
     ...
     */
     const char *hardUsername= my_username();
     char *fileUsername= malloc_username_from_conf_file();
     TEST_ASSERT_EQUAL_STRING_MESSAGE(hardUsername,fileUsername,"Username matches");
